package com.homework.demo.aspect;

import com.homework.demo.config.CurDataSource;
import com.homework.demo.config.DataSourceNames;
import com.homework.demo.config.DynamicDataSource;
...
public class DataSourceAspect implements Ordered {
    @Pointcut("@annotation(com.homework.demo.config.CurDataSource)")
